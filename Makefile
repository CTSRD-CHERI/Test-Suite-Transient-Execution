...
OBJDUMP_OPTS = --disassemble-all --disassemble-zeroes --section=.text --section=.text.startup --section=.text.init --section=.data --section=.acode --section=.auipccode --section=.sand0 --section=.sand1 --section=.sand2 --section=.kernel --section=.user --section=.kernel_btb_s --section=.kernel_btb_u --section=.spec_btb_attack
